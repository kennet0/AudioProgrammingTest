...
{
    RotarySliderWithLabels(juce::RangedAudioParameter& rap, juce::String unitSuffix ) : juce::Slider(juce::Slider::SliderStyle::RotaryHorizontalVerticalDrag,
...
juce::Timer
{
    ResponseCurveComponent(JhanEQAudioProcessor&);
